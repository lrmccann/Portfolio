...
import photo from "../../images/left-carrot.png";
import "./style.css";
  ...
  if(unextended === true){
    return(
      <div className="helloTwo">
        <button className="contact-btn btn-secondary" onClick={extend}><img className="carrot" src={photo} ></img></button>
        </div>
    )
}
if(extended === true){
  return (
    ...
    <div className="card side">
       ...
       <div >
        ...
        <div>
        <button className="carrot-btn" onClick={unextend}><img src={photo} className="carrotTwo"></img></button>
        {/* <div style={{marginLeft:"33%", marginBottom:"28%"}}>
        </div> */}
        </div>
    </div>
