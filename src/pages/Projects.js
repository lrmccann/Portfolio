          ...
          {(projectsToMap.map((item) => (
            <Fade right key={item.name}>
              <div id={"card-id-" + item.id} className="project-card">
                <img className="project-image" src={item.smallImage} alt="currently selected project"></img>
        ...
        <div className="project-div container-fixed" >
          ...
          <div className="link-bar container-fixed">
            <div id="link-btn-cont">
              <a id="link-btn" href={currentlySelectedProject.githubLinkFE} target="_blank" rel="noopener noreferrer">
                <img id="link-img" alt="Github Link" src={require("../page-images/github-lg.png")}></img>
              </a>
            </div>
            <div id="link-btn-cont" >
              <a id="link-btn" href={currentlySelectedProject.deployedSite} target="_blank" rel="noopener noreferrer">
                <img id="link-img" alt="Deployment Link" src={require("../page-images/web-lg.png")}></img>
              </a>
            </div>
            <div id="link-btn-cont">
              <a id="link-btn" href={currentlySelectedProject.awsS3Link} target="_blank" rel="noopener noreferrer">
